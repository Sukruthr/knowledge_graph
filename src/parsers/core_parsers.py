"""
Core biomedical data parsers for Gene Ontology and Omics data.

This module contains the fundamental parser classes that handle core data types:
- GODataParser: Single namespace GO parsing (BP, CC, MF)
- OmicsDataParser: Multi-modal omics data (diseases, drugs, viral, expression)
- CombinedGOParser: Multi-namespace GO coordinator

These parsers form the foundation of the biomedical knowledge graph system.
"""
